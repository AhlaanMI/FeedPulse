  ...
  describe('POST /api/feedback - Submit Feedback', () => {
    it('should submit valid feedback successfully', async () => {
      const feedback = {
        ...
        description: 'When I try to open the app in the morning, it crashes immediately without any error message displayed.',
        category: 'Bug',
    ...
    it('should reject feedback with empty title', async () => {
      const feedback = {
        title: '',
        description: 'This is a valid description that is longer than 20 characters'
      };
    ...
    it('should reject invalid email format', async () => {
      const feedback = {
        ...
        description: 'This is a valid description that is longer than 20 characters for sure.',
      ...
      const feedbackItems = [
        {
          ...
          description: 'This is a long description for bug report testing purposes and should be saved correctly in the database.',
          category: 'Bug',
          status: 'New',
          ai_priority: 8,
        ...
        },
        {
          ...
          description: 'This is a long description for feature request testing purposes and should be saved correctly in the database.',
        ...
        },
        {
          ...
          description: 'This is a long description for improvement testing purposes and should be saved correctly in the database.',
